...
public class RegroupCollective {
  ...
  public static void main(String args[])
    ...
    for (int i = 0; i < numPartitions; i++) {
      ...
      Partition<DoubleArray> partition =
        new Partition<DoubleArray>(i, doubleArray);
  ...
  public static <P extends Simple> boolean
    ...
    List<Transferable> recvPCounts =
      new LinkedList<>();
    boolean isSuccess =
      PartitionUtil.regroupPartitionCount(
        contextName, operationName
          + ".regroup.meta", table, recvPCounts,
        partitionMap, partitioner, dataMap,
        workers);
    if (!isSuccess) {
      return false;
    }
  ...
  public static
    <P extends Simple, PF extends PartitionFunction<P>, PT extends Partitioner>
  ...
  public static
    ...
    isSuccess =
      regroupAggregate(contextName, operationName
        + ".regroup", table, partitioner,
        function, dataMap, workers);
